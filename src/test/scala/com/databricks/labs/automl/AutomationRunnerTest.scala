...
class AutomationRunnerTest extends AbstractUnitSpec {
  ...
  it should "throw IllegalArgumentException with wrong evolution strategy" in {
    a [IllegalArgumentException] should be thrownBy {
      ...
      val fullConfig = AutomationUnitTestsUtil.getXgBoostConfig(adultDfwithLabel, "err")
  ...
  it should "throw AssertionError with wrong label column" in {
    a [AssertionError] should be thrownBy {
      val adultDfwithLabel = AutomationUnitTestsUtil.getAdultDf()
      new AutomationRunner(adultDfwithLabel).setLabelCol("label_test").runWithConfusionReport()
    }
  }
  ...
  it should "throw IllegalArgumentException with wrong modeling family" in {
    a [IllegalArgumentException] should be thrownBy {
      val adultDfwithLabel = AutomationUnitTestsUtil.getAdultDf()
      new AutomationRunner(adultDfwithLabel).setModelingFamily("test").runWithConfusionReport()
    }
  }
  ...
  it should "throw IllegalArgumentException with wrong firstGenerationGenePool config" in {
    a [IllegalArgumentException] should be thrownBy {
      val adultDfwithLabel = AutomationUnitTestsUtil.getAdultDf()
      new AutomationRunner(adultDfwithLabel).setFirstGenerationGenePool(1).runWithConfusionReport()
    }
  }
  ...
  it should "throw AssertionError with empty input dataset with no schema" in {
    a [AssertionError] should be thrownBy {
      new AutomationRunner(AutomationUnitTestsUtil.sparkSession.emptyDataFrame).runWithConfusionReport()
    }
  }
  ...
  it should "throw IllegalArgumentException with zero number of generations" in {
    a [IllegalArgumentException] should be thrownBy {
      val adultDfwithLabel = AutomationUnitTestsUtil.getAdultDf()
      new AutomationRunner(adultDfwithLabel).setNumberOfGenerations(0).runWithConfusionReport()
    }
  }
  ...
  it should "throw IllegalArgumentException with zero number of parents To retain" in {
    a [IllegalArgumentException] should be thrownBy {
      val adultDfwithLabel = AutomationUnitTestsUtil.getAdultDf()
      new AutomationRunner(adultDfwithLabel).setNumberOfParentsToRetain(0).runWithConfusionReport()
    }
  }
  ...
  it should "throw IllegalArgumentException with zero number of mutations per generation" in {
    a [IllegalArgumentException] should be thrownBy {
      val adultDfwithLabel = AutomationUnitTestsUtil.getAdultDf()
      new AutomationRunner(adultDfwithLabel).setNumberOfMutationsPerGeneration(0).runWithConfusionReport()
    }
  }
  ...
  it should "throw IllegalArgumentException with zero genetic mixing" in {
    a [IllegalArgumentException] should be thrownBy {
      val adultDfwithLabel = AutomationUnitTestsUtil.getAdultDf()
      new AutomationRunner(adultDfwithLabel).setGeneticMixing(0).runWithConfusionReport()
    }
  }
  ...
  it should "throw IllegalArgumentException with wrong generational mutation strategy" in {
    a [IllegalArgumentException] should be thrownBy {
      val adultDfwithLabel = AutomationUnitTestsUtil.getAdultDf()
      new AutomationRunner(adultDfwithLabel).setGenerationalMutationStrategy("err").runWithConfusionReport()
    }
  }
  ...
  it should "throw IllegalArgumentException with wrong feature importance cutoff type" in {
    a [IllegalArgumentException] should be thrownBy {
      val adultDfwithLabel = AutomationUnitTestsUtil.getAdultDf()
      new AutomationRunner(adultDfwithLabel).setFeatureImportanceCutoffType("err") .runWithConfusionReport()
    }
  }
